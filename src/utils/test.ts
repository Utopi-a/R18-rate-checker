const encodedKeyword = encodeURIComponent("月村手毬");

const response = await fetch(
  `https://www.pixiv.net/ajax/search/illustrations/${encodedKeyword}?word=${encodedKeyword}&order=date_d&mode=all&p=1&csw=0&s_mode=s_tag&type=illust_and_ugoira&lang=ja`,
  {
    headers: {
...
console.log(json.body.illust.total);
